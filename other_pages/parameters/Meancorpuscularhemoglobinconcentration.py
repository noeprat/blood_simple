...
st.markdown('''# Mean corpuscular hemoglobin concentration''')
st.write('''Mean corpuscular hemoglobin concentration is the average amount of hemoglobin concentration in the red blood cells. Hemoglobin is an important protein that allows red blood cells to carry oxygen.''')
